...
function returned_info(profs) {
    ...
    profs[selected_prof]['theme'] = format(profs[selected_prof]['theme'], {
        name: name,
        surname: surname,
        num_hw: num_hw,
    })
    profs[selected_prof]['text'] = format(profs[selected_prof]['text'], {
        name: name,
        surname: surname,
        num_hw: num_hw,
    })
...
let themes = [
    ...
    'ИТМО. Магистратура. ДМ-2022. ДЗ-{num_hw}. {surname}',
    default_theme,
]
