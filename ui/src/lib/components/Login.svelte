...
<main>
    ...
    <div class="notification is-info content" style="background-color: #4caf50">
        Для входа в аккаунт введите почту и пароль приложения почты (НЕ АККАУНТА), который можно получить по следующим
        инструкциям:
        <ul>
    ...
    <div class="block">
        <Select options={providers} id="smtpService" title="Сервис почты" bind:value={smtpService}/>
    </div>
